...
public class RackList extends AsyncTask<String,Void,String []> {
    private MainActivity context;

    public RackList(MainActivity context) {
    ...
    protected String[] doInBackground(String... strings) {
        ...
        try {
            ...
            login_url= context.getResources().getString(R.string.rackListAPI);
